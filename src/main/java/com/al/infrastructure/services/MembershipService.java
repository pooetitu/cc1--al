...
public class MembershipService {
    ...
    private final MembershipApplicationValidator membershipApplicationValidator;
    private final PaymentService paymentService;

    public MembershipService(MembershipRepository membershipRepository, MembershipApplicationValidator membershipApplicationValidator, PaymentService paymentService) {
    ...
    public void addMembership(MembershipApplication membershipApplication) {
        if(membershipApplicationValidator.validateMembership(membershipApplication) && paymentService.processPayment()) {
